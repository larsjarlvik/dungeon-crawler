...
pub const SL: f32 = 60.0;
pub const SM: f32 = 32.0;
pub const SS: f32 = 20.0;

pub const ICON_L: f32 = 72.0;
pub const ICON_M: f32 = 48.0;
...
pub const PALETTE_LIGHT_GRAY: Vector3<f32> = Vector3::new(0.399, 0.399, 0.399);
