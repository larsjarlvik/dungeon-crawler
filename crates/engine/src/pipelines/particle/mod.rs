...
impl ParticlePipeline {
    ...
    pub fn render(&self, ctx: &Context, components: &mut World, target: &wgpu::TextureView, depth_target: &wgpu::TextureView) {
    ...
    pub fn create_emitter(&self, ctx: &Context, count: u32, life_time: f32, spread: f32, speed: f32) -> ParticleEmitter {
